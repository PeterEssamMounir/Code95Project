...
function add_custom_icon_library_to_elementor($icons) {
    // Specify the path to your SVG icons directory
    $custom_icons_path = get_template_directory_uri() . '/custom-icons/';
    
    $custom_icons = [
        'custom-icon-1' => $custom_icons_path . 'icon1customarrow.svg', // Adjust 'icon1.svg' with your actual file name
        'custom-icon-2' => $custom_icons_path . 'icon2customarrow.svg', // Repeat as needed
    ];
    ...
    $icons['custom_icons'] = [
        ...
        'prefix'        => '',
        'displayPrefix' => '',
        'labelIcon'     => 'fas fa-star',  // You can use any default Font Awesome icon for the label
        'ver'           => '1.0',
        'fetchJson'     => '',
        'icons'         => $custom_icons,
        'native'        => false,
...
add_filter('elementor/icons_manager/additional_icons', 'add_custom_icon_library_to_elementor');
